...
$botToken = "7760154469:AAFMteXwMHZU27J0aCqlUjqgaheZaJf6T9w";
...
$botu = "𝘽𝙊𝙏 𝙐𝙋𝘿𝘼𝙏𝙀𝙎 ↯ @OmenXD_Bins";
$bota = "<b>|×| 𝘿𝙀𝙑 ↯ @mR_oMeNxD</b>";$eror = "<b>Error ❌</b>";
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "↯ 𝘽𝙐𝙔 𝘼𝘾𝘾𝙀𝙎𝙎", 'url' => "https://t.me/mR_oMeNxD"],
        ],
    ]
]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝙊𝙒𝙉𝙀𝙍", 'url' => "t.me/mR_oMeNxD"], ['text' => "𝘾𝙃𝘼𝙉𝙉𝙀𝙇", 'url' => "https://t.me/OmenXD_Bins"]],
        [['text' => "𝙂𝙊 𝘽𝘼𝘾𝙆 ", 'callback_data' => 'back2']]
    ]
]);
